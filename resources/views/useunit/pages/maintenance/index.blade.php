                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <a type="button" class="btn btn-success" href="{{route('report.index')}}">
                                    <i class="fa-solid fa-plus" title="Thêm phiếu bảo trì"></i>
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                            <table id="example-table" class="table table-bordered table-hover">
                                ...
                                @php
                                    $counter = 1;
                                @endphp
                                @foreach ($maintenances as $items)
                                    <tr id="maintenance-{{ $items->maintenance_id }}">
                                        <td>{{ $counter++ }}</td>
                                        ...
                                        <td>
                                            <a href="{{route('main.maintenance', $items->maintenance_id)}}" class="btn btn-info btn-sm" title="Chi tiết">
